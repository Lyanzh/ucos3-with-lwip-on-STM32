...
void lwip_comm_dhcp_creat(void)
{
	...
	OSTaskCreate((OS_TCB	* )&lwip_dhcp_tcb,	
				 ...
				 (CPU_STK_SIZE)LWIP_DHCP_STK_SIZE/10,	
				 (CPU_STK_SIZE)LWIP_DHCP_STK_SIZE,	
				 (OS_MSG_QTY  )0,
				 (OS_TICK	  )0,					
				 (void		* )0,					
...
void lwip_comm_dhcp_delete(void)
{
	...
	OSTaskDel(&lwip_dhcp_tcb, &err);//删除DHCP任务
}
//DHCP处理任务
void lwip_dhcp_task(void *pdata)
{
